    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2 flex flex-col">
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
          <div className="w-[200px] cursor-pointer  border rounded-md py-2 text-center flex items-center justify-center opacity-55" onClick={() => api.scrollPrev()}><FaArrowLeft className="mr-5" /> <p>Volver</p></div>
